...
if(temperature >= 80 && rain === true) {
  ...
  console.log("Wear a t-shirt and forget that umbrella");
  ...
  console.log("You should wear a jacket and carry an unmrella");
} else if (temperature < 60 && rain === false) {
  console.log("You should wear a jacket but forget that umbrella")
} else {
